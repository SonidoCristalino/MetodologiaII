...
En el modelado del sistema, también se tuvo en cuenta un tipo de \textbf{reporte} el cual permite obtener una lista de
clientes ordenados por nombre. 

\subsection{Diccionario}

El sistema permite asimismo una \textbf{consulta} para saber a qué cliente le corresponde qué cancha. La misma permite
obtener un reporte obteniendo la cancha alquilada y por quién se encuentra alquilada. 
...
Se mejoró los nombres de las variables más descriptivos. Asimismo se mejoró el código del método \textbf{nuevaReserva}
que implementa en la clase Club.
